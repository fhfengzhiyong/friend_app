...
public final class MeFragment_
    extends com.straw.friend.fargment.MeFragment
    implements HasViews, OnViewChangedListener
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (contentView_ == null) {
            contentView_ = inflater.inflate(layout.mefragment, container, false);
        }
        return contentView_;
    }
    ...
    public static class FragmentBuilder_
        extends FragmentBuilder<MeFragment_.FragmentBuilder_, com.straw.friend.fargment.MeFragment>
    {


        @Override
        public com.straw.friend.fargment.MeFragment build() {
